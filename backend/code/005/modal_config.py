"""
Modal deployment for MVE 005: Segmented-HSS Linear Attention.
...
N_GPUS = 1
GPU_TYPE = "T4"
TIMEOUT = 1800  # 30 min default for MVE
...
volume = Volume.from_name("mve-005-results", create_if_missing=True)

app = App("mve-005-hss-linear-attention")
