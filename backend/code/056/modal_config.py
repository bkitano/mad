"""
Modal deployment for MVE 056: FlashMask Tile-Skip for Chunkwise Linear RNN

GPU Selection: A100 (needed for Triton kernel benchmarking)
...
volume = Volume.from_name("mve-056-results", create_if_missing=True)

app = App("mve-056-flashmask-tileskip")
...
def train_with_config(config_content: str):
    """Run benchmark with the provided config content."""
    import subprocess
    import tempfile
    import shutil
