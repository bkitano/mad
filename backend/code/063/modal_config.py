"""
Modal deployment for MVE 063: MFA-Style Shared Latent Projections for Linear RNN

Tests MFA-GLA (shared latent projections) vs standard GLA on MQAR task.
...
volume = Volume.from_name("mve-063-results", create_if_missing=True)

app = App("mve-063-mfa-gla-shared-projections")
...
def train_with_config(config_content: str):
    ...
    if os.path.exists(results_file):
        shutil.copy2(results_file, "/results/results.json")
