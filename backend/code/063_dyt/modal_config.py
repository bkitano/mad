"""
Modal deployment for MVE 063: DyT vs RMSNorm in GLA.

Tests whether Dynamic Tanh (DyT) can replace RMSNorm in GLA
architecture without quality degradation.
