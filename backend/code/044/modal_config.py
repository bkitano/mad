"""
Modal deployment for Experiment 044: MatMulScan Inter-Chunk State Scan Benchmark

This is a pure microbenchmark comparing inter-chunk scan implementations.
Needs A100 for tensor cores (fair comparison of scan algorithms).

Usage:
    cd /home/bkitano/Desktop/vault/projects/mad-architecture-search/code/044
...
volume = Volume.from_name("mve-044-results", create_if_missing=True)

app = App("mve-044-matmulscan-scan")
...
def run_benchmark(config_content: str):
    """Run the benchmark on Modal with GPU."""
    import subprocess
    import tempfile
