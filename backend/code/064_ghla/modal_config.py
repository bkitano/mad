"""
Modal deployment for MVE 064 (GHLA): Gated Second-Order Linear Attention

GPU Selection: T4 (default for MVEs, ~100K param model, < 10 min training per variant)
...
volume = Volume.from_name("mve-064-ghla-results", create_if_missing=True)

app = App("mve-064-ghla")
