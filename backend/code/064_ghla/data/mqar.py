...
Example with 3 key-value pairs, vocab_size=32:
  Keys are from [0, num_keys), Values from [num_keys, num_keys+num_values)
  Input:  k1 v1 k2 v2 k3 v3 SEP q1 q2 q3 SEP PAD ...
  Target: -100 ... -100 a1 a2 a3 -100 ...

Where q_i is one of {k1, k2, k3} and a_i = v_j where k_j = q_i.
...
def generate_mqar_data(
    ...
    num_keys = (vocab_size - 2) // 2
    num_values = (vocab_size - 2) // 2
    SEP = vocab_size - 1
    PAD = vocab_size - 2

    # Sequence structure:
    # [k1 v1 k2 v2 ... kN vN SEP q1 q2 ... qN SEP a1 a2 ... aN PAD...]
    # Minimum length: 2*N + 1 + N + 1 + N = 4*N + 2
