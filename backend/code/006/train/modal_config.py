"""
Modal deployment for MVE 006: Monarch-Gated State Transition SSM
...
volume = Volume.from_name("mve-006-results", create_if_missing=True)

app = App("mve-006-monarch-gated-ssm")
