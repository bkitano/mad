"""
Modal deployment for MVE 016: GS-Monomial SSM on S5 Permutation Composition
...
volume = Volume.from_name("mve-016-results", create_if_missing=True)

app = App("mve-016-gs-monomial-ssm")
...
def train_with_config(config_content: str):
    ...
    if os.path.exists(results_file):
        ...
        print("Results saved to volume at /results/results.json")
