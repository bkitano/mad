"""
Modal deployment for Experiment 040: Persistent Megakernel Fusion MVE

Runs kernel fusion benchmarks on GPU via Modal.
...
volume = Volume.from_name("mve-040-results", create_if_missing=True)

app = App("mve-040-megakernel-fusion")
...
def run_benchmark_remote(config_content: str):
    ...
    with open("/results/040_output.txt", "w") as f:
        f.write(output_text)
