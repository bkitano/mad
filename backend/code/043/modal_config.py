"""
Modal deployment for MVE 043: Newton-Schulz Orthogonal DeltaNet Transition
...
volume = Volume.from_name("mve-043-results", create_if_missing=True)

app = App("mve-043-ns-deltanet")
...
def train_with_config(config_content: str):
    ...
    cmd = ["python", "-m", "train.run_config", "--config", config_path]
