"""
Modal deployment for MVE 059: Second-Order KDA (SO-KDA)

GPU Selection: T4 (default for MVEs, ~200K param model, < 10 min training)
...
volume = Volume.from_name("mve-059-results", create_if_missing=True)

app = App("mve-059-so-kda")
