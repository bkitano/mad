"""Web search via Tavily — used by the chat agent and exposed via MCP.

Requires TAVILY_API_KEY in the environment. Returns LLM-ready results: a short
answer summary plus a list of source URLs with titles and snippets.
"""
